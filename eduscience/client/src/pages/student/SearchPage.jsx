...
const SearchPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      <div className="my-6">
        <h1 className="font-bold text-xl md:text-2xl">Resultat pour "{query}"</h1>
        <p>
...
const CourseNotFound = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-32 dark:bg-gray-900 p-6">
      ...
      Désolé, nous n'avons pas trouvé le Cours que vous recherchez.
      </p>
      <Link to="/" className="italic">
        <Button variant="link">Parcourir tous les Cours</Button>
      </Link>
    </div>
  );
};
